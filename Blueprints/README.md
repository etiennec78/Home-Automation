...
<details>
  ...
  | #29 | You have set a value for your GPS request refresh rate, but GPS requests are disabled | Either enable 'Request GPS location', or set 'GPS request refresh rate while open' to 0 |
