...
| GPS location tracker  |     person     |     [Companion]([https://www.home-assistant.io/integrations/mobile_app/](https://companion.home-assistant.io/docs/core/location))      |   Yes    | Try to avoid using wifi/ble location trackers as latency could be an issue. Use high precision when driving near home |
...
|    [Ble car device](https://github.com/etiennec78/Home-Automation/tree/master/Automatic%20Gate/Extra/Ble%20car%20device)     | A really small Arduino code to let a ESP32 sit in your car and show up as a BLE device so that your phone can connect to it and monitor if you are in your car   |
